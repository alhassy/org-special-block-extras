...
** The doc:org->html macro                      :ignore:needs_cleaning_up:tests:
   :PROPERTIES:
   :CUSTOM_ID: The-doc-org->html-macro
   :END:

#+begin_details "org->html: A ‘M’arkup ‘L’anguage for making HTML using Lisp symbols, vectors, and keywords"
#+begin_src emacs-lisp
