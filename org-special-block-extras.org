...
# TODO make this function take a varidaic number of arguments, instead of a
# solid list. Also, when called interactively allow users to input the name of a file.
# (o-docs-load-libraries '("~/org-special-block-extras/documentation.org"))
...
* Nice Keystroke Renditions: kbd:C-h_h :Outdated_Screenshot:
  :PROPERTIES:
  :CUSTOM_ID:
  :END:
