...
BACKEND is the export back-end being used, as a symbol."
  ...
  (cl-loop for blk in org--supported-blocks
	  ...
	  (-let [val (eval `(,(intern (format "org-block/%s" blk))
	    ...
	    (when (or (equal blk 'margin) (equal blk 'remark)) (setq val (format "@@html: %s@@" (s-replace "@" "＠" (s-chop-prefix "#+begin_export html \n" (s-chop-suffix "\n#+end_export" val))))))
            (insert val))
...
* DONE COMMENT Block and link types provided by this package
...
;; We provide two synonymous names “margin” and “remark”,
