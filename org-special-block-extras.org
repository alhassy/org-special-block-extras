...
#+macro: blurb Twenty-eight new custom block and 30 link types for Emacs' Org-mode ^_^
...
* COMMENT /How do I make a new special block?/ ---Core Utility
  :PROPERTIES:
...
* COMMENT /How do I make a new link type?/
  :PROPERTIES:
  :CUSTOM_ID: Links
  :END:
...
* COMMENT Lisp Postamble                                                   :noexport:
  :PROPERTIES:
  :CUSTOM_ID: Postamble
  :END:
#+BEGIN_SRC emacs-lisp
