...
* Table of Contents :TOC:QUOTE:ignore:
  ...
  :END:
#+BEGIN_QUOTE
- [[#how-do-i-make-a-new-special-block----core-utility][/How do I make a new special block?/ ---Core Utility]]
  - [[#what-is-a-special-block][/What is a special block?/]]
  - [[#core-utility][Core Utility]]
  - [[#argument-extraction][=:argument:= Extraction]]
  - [[#an-example-special-block----foo][An Example Special Block ---=foo=]]
  - [[#next-steps][Next Steps]]
- [[#how-do-i-make-a-new-link-type][/How do I make a new link type?/]]
- [[#colours][Colours]]
  - [[#org-special-block-extras--𝒞-where-𝒞--org-special-block-extras--colors][=org-special-block-extras--𝒞= where ~𝒞 ∈ org-special-block-extras--colors~]]
  - [[#block-examples][Block Examples]]
  - [[#colour-link-types][Colour Link Types]]
  - [[#next-steps-1][Next Steps]]
- [[#parallel][Parallel]]
  - [[#example][Example]]
  - [[#next-steps-2][Next Steps]]
- [[#editor-comments][Editor Comments]]
  - [[#block-examples-1][Block Examples]]
  - [[#link-type][Link Type]]
- [[#folded-details][Folded Details]]
  - [[#example-1][Example]]
- [[#link-here-octoicon][/“Link Here!”/ OctoIcon]]
- [[#badge-links][Badge Links]]
  - [[#the-badge-link-and-derived-redditgithubtwitter-socials][The =badge= Link and derived Reddit/Github/Twitter socials]]
  - [[#example-social-icons][Example Social Icons]]
  - [[#example-badges][Example Badges]]
  - [[#example-colours][Example Colours]]
  - [[#example-badge-icons][Example Badge Icons]]
  - [[#common-project-badges][Common Project Badges]]
...
(org-link-set-parameters "color"
 ...
 Observe: red:this green:is cyan:super teal:neato, purple:amigos! and [[color:brown][this is
 brown ‘color’ link]] and [[color:orange][this one is an orange ‘color’ link!]]
