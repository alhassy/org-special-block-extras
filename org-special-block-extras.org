...
:No_tests_yet:
1. badge links
2. the exercises after defblock
3. defblock and its helpers; e.g., using defblock causes certain Lisp functions
   to be defined. ---Test should first make unbound such functions, ignoring errors.
:End:
