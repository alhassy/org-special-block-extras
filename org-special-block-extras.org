...
(cl-defmacro org-defblock
  (name main-arg kwds &optional link-display docstring &rest body)
...
Three example uses:
  ...
  (cl-destructuring-bind (link-display docstring body)
      (lf-extract-optionals-from-rest link-display #'vectorp
                                      ...
                                      body)
    `(progn
       ;; TODO: Temp, delete this when done refactoring.
       (cl-assert (null (quote ,main-arg)))
...
(org-defblock rremark
  nil (editor "Editor Remark" color "red" signoff "")
  (vector :face angry-red)
...
A full example:
    ...
    (org-defblock nesting nil (name nil)
...
(org-defblock solution
  nil (title "Solution" reprimand "Did you actually try? Maybe see the ‘hints’ above!"
...
#+begin_details Implementation
 #+begin_src emacs-lisp
(org-defblock org-demo nil (nil nil source "Source" result "Result"
...
#+begin_solution
#+begin_src emacs-lisp
(org-defblock stutter nil (reps 2)
  "Output the CONTENTS of the block REPS many times"
...
#+begin_src emacs-lisp
(org-defblock spoiler nil (color "grey" left "((" right "))")
...
(org-defblock tree nil (main-arg)
...
#+begin_details Implementation
#+begin_src emacs-lisp
(org-defblock details nil (title "Details"
...
#+begin_details Implementation
 #+begin_src emacs-lisp
(org-defblock box nil (title "" background-color nil shadow nil)
...
#+begin_details Implementation
  #+begin_src emacs-lisp -r -n
(org-defblock parallel nil (cols "2" bar nil)
...
(org-defblock remark
      nil (editor "Editor Remark" color "black" signoff "" strong nil)
...
(org-defblock documentation
  nil (name (error "Documentation block: Name must be provided")
...
* TODO Marginal, “one-off”, remarks :FIXME:HTML_EXPORT_HAS_UNEXPECTED_NEW_LINES:
  :PROPERTIES:
