...
#+begin_src latex-as-png :file org-special-block-extras-overview.png :resolution "720" :results raw value replace :exports results
\usepackage{smartdiagram}
\usepackage{graphicx}
\vspace{1.5em}
\centering{One Org source $\rightarrow$ rich HTML \emph{and} \LaTeX\ export}
...
\smartdiagram[constellation diagram]{%
  {\color{white}\LARGE\texttt{org-special-block-extras}\\[0.5em]\normalsize define blocks \& links},
  \texttt{org-defblock}\\[0.5em]{\footnotesize custom Org blocks},
  \texttt{details}\ \texttt{parallel}\\[0.5em]\texttt{proof}\ \texttt{margin}\\[0.5em]{\footnotesize 30+ block types},
  \texttt{org-deflink}\\[0.5em]{\footnotesize custom Org links},
  \texttt{doc:}\ \texttt{kbd:}\\[0.5em]\texttt{badge:}\ \texttt{fortune:}\\[0.5em]{\footnotesize 34+ link types},
  HTML \& \LaTeX\\[0.5em]{\footnotesize single Org source},
  \texttt{spoiler}\ \texttt{tree}\\[0.5em]\texttt{demo}\ \texttt{solution}\\[0.5em]{\footnotesize interactive export}
...
;; TODO Add a hook to run tests whenever I produce an export!
...
(use-package org-special-block-extras
  ...
  :custom
    ...
    (org-link-twitter-excitement
     "This looks super neat (•̀ᴗ•́)و:")
    :config
    ;; fortune: link type moved to https://github.com/alhassy/fortune-of-the-day
    )
#+END_SRC
