...
FIRST: In Github, you must “Actions → New WorkFlow → Get Started → Commit”,
Then & only then: Update the main.yml to the following.
(Otherwise, for some reason, the workflow will not be triggered automatically.)
...
#+html: <span>
badge:org-special-block-extras|2.3|informational|https://github.com/alhassy/org-special-block-extras|Gnu-Emacs
