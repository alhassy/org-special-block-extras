...
[[color:orange][Going forward]], it would be nice to render =kbd:𝒳= links in a pretty way
within Emacs itself.
...
[[color:orange][Moreover]], it may be useful to have =octoicon:𝒳|url= so the resulting
