...
+ Textual expansions :: =show:user-full-name= expands, upon export, to /Musa
  Al-hassy/ on my machine. (doc:o-link/show is defined below.)
  ...
  article. (doc:o-link/link-here is defined below; as is doc:o-link/octoicon
  with example use: ~octoicon:home~ being octoicon:home.)
...
+ Definitions / Personal Glossary :: ~doc:thread-first, doc:family, doc:Hussain~
  ...
  documentation for the phrase doc:Hussain. (doc:o-link/doc is defined below.)
...
(org-link-set-parameters
 ...
 :keymap (let ((map (copy-keymap org-mouse-map)))
  ...
  : o-html-export-preserving-whitespace
